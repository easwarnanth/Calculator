...
var input = create('input', 'col-8 border-3 border-light text-right mt-5 mb-0.5');
input.setAttribute('type', 'text');
input.disabled = true;
input.setAttribute('style', `line-height:80px; background-color:white; font-family: 'Comfortaa', cursive;`);
input.id = "display";
